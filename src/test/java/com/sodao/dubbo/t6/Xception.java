...
public class Xception extends Exception implements org.apache.thrift.TBase<Xception, Xception._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Xception other) {
    ...
    Xception typedOther = (Xception)other;
